...
use aptos_types::error::{NonPanic, PanicError, PanicOr};
...
// TODO: this method does not belong here, and we need to find a better place for it.
// Some issues are: (a) putting it in aptos-types introduces circular dependencies
// due to certain aptos-specific includes in crates/aptos-logger, (b) code_invariant_error
// is also redefined in third-party/move-vm (for delayed fields errors).
